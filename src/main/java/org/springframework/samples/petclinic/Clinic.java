...
public interface Clinic {
     ...
     * @throws DataAccessException an exception while accessing data
     */
    ...
    /**
     * Deletes an <code>Owner</code> from the data store.
     */
    void deleteOwner(int id) throws DataAccessException;
}
