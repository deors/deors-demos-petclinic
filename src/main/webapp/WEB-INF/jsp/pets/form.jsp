  ...
  <table>
    ...
    <tr>
      <td>
        <c:choose>
          <c:when test="${pet['new']}">
            <p class="submit"><input id="addpet" type="submit" value="Add Pet"/></p>
          </c:when>
          <c:otherwise>
            <p class="submit"><input id="updatepet" type="submit" value="Update Pet"/></p>
          </c:otherwise>
        </c:choose>
      </td>
    </tr>
...
<c:if test="${!pet['new']}">
  <form:form method="delete">
    <p class="submit"><input id="deletepet" type="submit" value="Delete Pet"/></p>
  </form:form>
</c:if>
